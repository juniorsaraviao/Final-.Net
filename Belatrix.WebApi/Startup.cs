...
namespace Belatrix.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient(option => new ChinookContext(new DbContextOptionsBuilder<ChinookContext>().UseMySQL<ChinookContext>(Configuration.GetConnectionString("MySql")).Options));
